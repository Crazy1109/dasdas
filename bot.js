...
client.on("message", message => {
 ...
 if (message.content === "&help") {
  ...
  const embed = new Discord.RichEmbed() 
      ...
      .setDescription(`
			  اوامر البوت
❖-ban @user <reason> ~ لإعطاء شخص باند من السيرفر
❖-kick @user <reason> ~ لاعطاء شخص كيك
❖-mute @user <reason> ~ عضو ميوت لازم رتبة 
❖-unmute @user ~ لفك الميوت عن الشخص 
❖-startr ~ لبدأ الرينبو
❖-stopr ~ لإيقاف الرينبو
...
client.on("message", message => {
  ...
  if(message.content.startsWith(prefix + "startr")) {
...
if(message.content.startsWith(prefix + "stopr")) {
  if(allowedUsers.includes(message.author.id)) {
